...
`StreamConsumer.process` (`docs/streaming-consumer.md`) already updates a
...
`RecentUserFeatures` record (`docs/online-features.md`) and writing it to
Redis (`docs/state-store.md`) via `save_recent_features`. Every other
