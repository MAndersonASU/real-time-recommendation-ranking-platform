...
Runs the six ranking features (`docs/ranking-features.md`) over real data
...
unlike retrieval's training data (`docs/retrieval-model.md`). Retrieval had
...
(`docs/retrieval-model.md`), and both positive rates land close to the
