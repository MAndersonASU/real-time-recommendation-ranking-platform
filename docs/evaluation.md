...
|---|---|---|
| Baselines | [`baselines.md`](experiments/baselines.md) | pending republication |
...
| Ranking | [`ranking-evaluation.md`](experiments/ranking-evaluation.md) | pending republication |
| Reranking | [`reranking-evaluation.md`](experiments/reranking-evaluation.md) | pending republication |
| All stages | [`stage-comparison.md`](experiments/stage-comparison.md) | pending republication |
| Ablations | [`ablations.md`](experiments/ablations.md) | pending republication |
| Failure modes | [`failure-analysis.md`](experiments/failure-analysis.md) | pending republication |
...
**Evidence status.** Seven legacy evaluation tables match their recorded
measurements but do not yet have committed, provenance-valid
machine-readable reports. Their reports require clean-tree artifact
reconstruction and full recomputation. No report was backfilled with
inferred or false provenance.
