...
(`docs/evaluation-protocol.md`) â€” but a genuinely different task: searching
...
at K=10 â€” these numbers are not directly comparable to the baseline table
...
reason** â€” not because learned embeddings are inherently weaker than the
